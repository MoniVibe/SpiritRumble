...
class HandZone extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        final draggedIndex = dragSession == null
            ? null
            : hand.indexWhere(
                (piece) => piece.instanceId == dragSession!.pieceId,
              );
        ...
        for (var i = 0; i < hand.length; i++) {
          final piece = hand[i];
          final slot = slots[i];
          final isDragged = dragSession?.pieceId == piece.instanceId;
          ...
          if (isDragged) {
            final translation = dragSession!.translation;
  ...
  Widget _buildHandPieceCard({
    ...
    final canStartDrag =
        ...
        (dragSession == null || dragSession?.pieceId == piece.instanceId);
    return Opacity(
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          onPanStart: canStartDrag
              ...
              : null,
          onPanUpdate: (isDragged && canStartDrag)
              ...
              : null,
          onPanEnd: (isDragged && canStartDrag) ? (_) => onDragEnd() : null,
          onPanCancel: (isDragged && canStartDrag) ? onDragCancel : null,
